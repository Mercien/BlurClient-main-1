...
const Home = () => {
  ...
  return (
    <div className="flex justify-center sm:px-4 p-12">
      <div style={myFont.style} className="w-full minmd:w-4/5">
        <Banner
          style={myFont.style}
          name={
            <>
              <span style={myFont.style}>Market NFTs</span>
              <br />
              <span style={myFont.style}>Buys and Sells</span>
            </>
          }
        ...
        {!isLoading && !nfts.length ? (
          <h1 className=" text-2xl minlg:text-4xl font-semibold ml-4 xs:ml-0">
          ...
          <>
            <div>
              <h1 className=" dark:text-white text-nft-black-1 text-2xl minlg:text-4xl font-semibold ml-4 xs:ml-0">
            ...
            <div className="mt-10">
              <div className="flexBetween mx-4 xs:mx-0 minlg:mx-8 sm:flex-col sm:items-start">
                <h1 className="flex-1  dark:text-white text-nft-black-1 text-2xl minlg:text-4xl font-semibold sm:mb-4">
                  Top NFTs
                </h1>
